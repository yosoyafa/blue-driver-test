...
//Track these seperatly, otherwise if we fail to connet due to our 60s timer window
//we cant reconnect, as discovery is nont called again.

@property(nonatomic, strong) NSMutableArray * devicesDiscoveredWhichHaveDisconnected;
/**
