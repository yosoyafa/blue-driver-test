...
/**
 * Custom BlueDriver error callback
 * Allows the internal errors to be forwarded to the BlueDriver source for better logging.
 */
-(void)notifyForDisconnectionError:(NSError *)error;
@end
